...
const Navbar = ({ match, history }) => {
  ...
  const content = (
    <div className="Categoriespobover">
      <Link to="/coursesfilter/development">Reading</Link> <br />
      <Link to="/coursesfilter/marketing">Speaking</Link>
      <br />
      <Link to="/coursesfilter/design">Writing</Link>
      <br />
      <Link to="/coursesfilter/education">Listening</Link>
      <br />
      <Link to="/coursesfilter/photography">Grammer</Link>
      <br />
      <Link to="/coursesfilter/music">Quiz</Link>
      <br />
