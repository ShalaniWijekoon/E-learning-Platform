        ...
        <Tabs defaultActiveKey="1" onTabClick={changetopic}>
          <TabPane tab="Reading" key="1">
            <div className="Tab_Content">
              ...
              <div id="paragraphbtn">
                <p>
                Here you can find activities to practise your reading skills. Reading will help you to improve your understanding 
                of the language and build your vocabulary.
                  <br />
                  The self-study lessons in this section are written and organised according to the levels of the Common European 
                  Framework of Reference for languages (CEFR). There are different types of texts and interactive exercises that 
                  practise the reading skills you need to do well in your studies, to get ahead at work and to communicate in English 
                  in your free time.
                </p>
                <Link
          ...
          <TabPane tab="Speaking" key="2">
            <div className="Tab_Content">
              <h2>Become a Hero in Speaking</h2>

              <div id="paragraphbtn">
                <p>
                Speak and Improve is a research project from the University of Cambridge. 
                By using it you are helping us improve technology that will help English learners around the world.
                all to our speech robot, Sandi, who will ask you some questions.
          ...
          <TabPane tab="Quiz" key="6">
            <div className="Tab_Content">
              ...
              <div className="coursecards">
                ...
                <a href="https://www.gamestolearnenglish.com/">Quiz01</a>
              </div>
            </div>
          </TabPane>
        </Tabs>
